...
docs = [l.strip() for l in open('input.txt', encoding="UTF8").read().strip().split('\n') if l.strip()] # list[str] of documents
# PAscal la liste de str en liste de mots
...
n_layer = 2 #1     # number of layers
block_size = 25# 8  # maximum sequence length
...
# Repeat in sequence
num_steps = 250 #500 # number of training steps
