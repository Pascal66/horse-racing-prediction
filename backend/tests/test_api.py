...
class MockRaceRepository:
    ...
    def get_daily_data_for_ml(self, date_code: str):
        return [
            # Case 1: Winner (Good Odds, High Edge)
            {
                ...
                "horse_name": "Sniper Choice", "reference_odds": 10.0, "program_date": "2025-12-28",
                "discipline": "ATTELE",
            ...
            # Case 2: Favorite (Odds too low)
            {
                ...
                "horse_name": "Low Odds Fav", "reference_odds": 2.0, "program_date": "2025-12-28",
                "discipline": "ATTELE",
                "live_odds": None, "live_odds_30mn": None
            },
    ...
    def get_race_data_for_ml(self, race_id: int):
        return [
            {"participant_id": 11, "program_number": 1, "horse_name": "Horse A", "reference_odds": 5.0,
             "discipline": "ATTELE", "program_date": "2025-12-28"},
            {"participant_id": 12, "program_number": 2, "horse_name": "Horse B", "reference_odds": 10.0,
             "discipline": "ATTELE", "program_date": "2025-12-28"}
        ]
